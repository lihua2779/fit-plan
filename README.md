...
- 常见食物营养参考表
- 自定义食材：录入每 100g 营养，输入重量自动换算，保存在本地
- 训练折叠 + 组间计时器：训练日折叠展开，60/90/120/150 秒全屏倒计时
- 体重 / 体脂追踪：每周记录，生成曲线并与热量缺口预期对照
- 训练打卡：日历点击打卡，统计连续训练天数
- 深色 / 浅色模式、字号放大、一键清空本地数据
- 导出升级：训练计划表 / 每日饮食表独立 PDF 打印，食材表 CSV 导出，.ics 带系统提醒
